...
Read `~/.agents/skills/development-philosophy/knowledge.md` for the full guidelines. Note: the path is `~/.agents`, not `~/.claude`.

**Note:** For project-specific development philosophy, check `.claude/CLAUDE.md` in the project directory.
