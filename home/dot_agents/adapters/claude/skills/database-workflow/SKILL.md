...
Read `~/.agents/skills/database-workflow/knowledge.md` for the full guidelines. Note: the path is `~/.agents`, not `~/.claude`.

**Note:** For project-specific database patterns, check `.claude/CLAUDE.md` in the project directory.
