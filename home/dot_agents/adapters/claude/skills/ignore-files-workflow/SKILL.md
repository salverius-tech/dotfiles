...
Read `~/.agents/skills/ignore-files-workflow/knowledge.md` for the full guidelines. Note: the path is `~/.agents`, not `~/.claude`.

**Note:** For project-specific ignore file patterns, check `.claude/CLAUDE.md` in the project directory.
