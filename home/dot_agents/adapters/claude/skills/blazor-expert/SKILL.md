...
Read `~/.agents/skills/blazor-expert/knowledge.md` for the full guidelines. Note: the path is `~/.agents`, not `~/.claude`.

**Note:** For project-specific Blazor patterns, check `.claude/CLAUDE.md` in the project directory.
