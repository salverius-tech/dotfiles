...
Read `~/.agents/skills/devcontainer-workflow/knowledge.md` for the full guidelines. Note: the path is `~/.agents`, not `~/.claude`.

**Note:** For project-specific DevContainer patterns, check `.claude/CLAUDE.md` in the project directory.
