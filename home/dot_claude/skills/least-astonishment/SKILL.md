...
Read `~/.agents/skills/least-astonishment/knowledge.md` for the full guidelines. Note: the path is `~/.agents`, not `~/.claude`.

**Note:** For project-specific POLA patterns, check `.claude/CLAUDE.md` in the project directory.
