...
Read `~/.agents/skills/multi-agent-ai-projects/knowledge.md` for the full guidelines. Note: the path is `~/.agents`, not `~/.claude`.

**Note:** For project-specific multi-agent patterns, check `.claude/CLAUDE.md` in the project directory.
